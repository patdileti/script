...
@section('title', ___('Blog Categories'))
@section('header_buttons')
    <a href="#" data-url="{{ route('admin.blog.category.create') }}" data-toggle="slidePanel" class="btn btn-primary ms-2"><i class="icon-feather-plus me-2"></i> {{ ___('Add New') }}</a>
@endsection
@section('content')
    <div class="quick-card card">
        <div class="card-body">
            <div class="dataTables_wrapper">
                <table class="table table-striped" id="ajax_datatable" data-jsonfile="{{ route('admin.blog.category.index') }}" data-reorder-route="{{ route('admin.blog.category.reorder') }}" data-order-dir="asc">
                    <thead>
                    <tr>
                        <th width="20"></th>
                        <th>{{ ___('Title') }}</th>
    ...
    <div class="site-action">
        <div class="site-action-buttons">
            <button type="button" id="quick-delete-button" data-action="{{ route('admin.blog.category.delete') }}"
        ...
        <button type="button" class="front-icon btn btn-primary btn-floating"
                data-url="{{ route('admin.blog.category.create') }}" data-toggle="slidePanel">
