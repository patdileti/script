                ...
                <div class="accordion" id="accordions">
                    ...
                    <div class="card accordion-item mb-3">
                        ...
                        <div id="facebook" class="accordion-collapse collapse" data-bs-parent="#accordions" style="">
                            <div class="accordion-body">
                                <div class="mb-3">
                                    {{quick_switch(___('Status'), 'facebook_login', @$settings->facebook_login == '1')}}
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="facebook_app_id" class="form-control"
                                                   value="{{ demo_mode() ? '*****' : @$settings->facebook_app_id }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="facebook_app_secret" class="form-control"
                                                   value="{{ demo_mode() ? '*****' : @$settings->facebook_app_secret }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="mb-3">
                    ...
                    <div class="card accordion-item mb-3">
                        ...
                        <div id="google" class="accordion-collapse collapse" data-bs-parent="#accordions" style="">
                            <div class="accordion-body">
                                <div class="mb-3">
                                    {{quick_switch(___('Status'), 'google_login', @$settings->google_login == '1')}}
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="google_app_id" class="form-control"
                                                   value="{{ demo_mode() ? '*****' : @$settings->google_app_id }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="google_app_secret" class="form-control"
                                                   value="{{ demo_mode() ? '*****' : @$settings->google_app_secret }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="mb-3">
